...
CASADI_SYMBOL_EXPORT int f_alloc_mem(void) { return 0; }

CASADI_SYMBOL_EXPORT int f_init_mem(int mem) { return 0; }

CASADI_SYMBOL_EXPORT void f_free_mem(int mem) {}

CASADI_SYMBOL_EXPORT int f_checkout(void) { return 0; }
...
CASADI_SYMBOL_EXPORT casadi_functions *f_functions(void) {
  static casadi_functions fun = {
      f_incref,       f_decref, f_checkout, f_release,  f_default_in,
      f_n_in,         f_n_out,  f_name_in,  f_name_out, f_sparsity_in,
      f_sparsity_out, f_work,   f};
  return &fun;
}
